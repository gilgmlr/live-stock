                        ...
                        <div class="card shadow p-2 mb-5 bg-white rounded">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning btn-sm" style="margin-left:8rem"
                                    data-bs-toggle="modal" data-bs-target="#MI">Material Issue</button>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow p-2 mb-5 bg-white rounded">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning btn-sm" style="margin-left:8rem"
                                    data-bs-toggle="modal" data-bs-target="#WO">Work Order</button>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow p-2 mb-5 bg-white rounded">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning btn-sm" style="margin-left:8rem"
                                    data-bs-toggle="modal" data-bs-target="#WT">Warehouse Transfer</button>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="container">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <button id="tambah_items" type="submit"
