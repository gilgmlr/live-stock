                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container px-1">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#change<?= $data->nip ?>"><i class="fa-solid fa-pencil"></i></a>
                                    </div>
                                    <div class="col-sm-2">
...
<!-- Modal Change -->
<div class="modal fade" id="change<?= $data->nip ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-sm-12">
                                <label class="col-sm-6 col-form-label" for="form3Example1c">NIP</label>
                                <input type="text" id="nip" class="form-control" name="nip" autocomplete="off"
                                    placeholder="Enter item code" value="<?= $data->nip ?>"required />
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-12"">
                                <label class="col-sm-6 col-form-label" for="form3Example1c">Name</label>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-6">
                                <label class="col-sm-6 col-form-label" for="form3Example1c">Password</label>
                                <input type="password" id="password" class="form-control" name="password" autocomplete="off"
                                    placeholder="Enter your password" required />
                            </div>
                            <div class="col-sm-6">
                                <label class="col-sm-6 col-form-label" for="form3Example1c">Password</label>
                                <input type="password" id="password2" class="form-control" name="password2" autocomplete="off"
                                    placeholder="Enter your password" required />
                            </div>
                        </div>
                        <div class="row justify-content-center">
