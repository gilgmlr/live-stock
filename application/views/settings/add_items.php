                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input style="border-color: black;" type="text" id="item_code" class="form-control" name="item_code" autocomplete="off"
                        ...
                        <div class="col-sm-4">
                            ...
                            <input style="border-color: black;" type="text" id="name" class="form-control" name="name" autocomplete="off"
                        ...
                        <div class="col">
                            ...
                            <input style="border-color: black;" type="text" id="uom" class="form-control" name="uom" autocomplete="off"
                    ...
                    <div class="col-sm-12">
                        ...
                        <textarea style="border-color: black;" id="spec" class="form-control" name="spec" autocomplete="off"
                    ...
                    <div class="col">
                        ...
                        <textarea style="border-color: black;" id="remarks" class="form-control" name="remarks" autocomplete="off"
                            placeholder="Enter remark" rows="2" ></textarea>
                    ...
                    <center>
                        <div class="col-sm-8 mt-4">
                            <label for="formFileMultiple" class="form-label" style="margin-top:8px"><b>Upload Image</b>
                                (.jpg |.jpeg |.png)</label>
                            <input style="border-color: black;" class="custom-file-input form-control" type="file" id="image"
