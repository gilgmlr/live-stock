                                    ...
                                    <form class="mx-1 mx-md-4" action="<?= base_url() ?>settings/add_item" method="POST">
                                        <div class="container px-4">
                                            <div class="col gx-5">
                                                ...
                                                <div class="col">
                                                    <label class="form-label" for="form3Example1c">Item Name</label>
                                                    <input type="text" id="name" class="text-input" name="name"
                                                        autocomplete="off" placeholder="Enter name" required />
                                                </div>
                                                <div class="col">
                                                    <label class="form-label" for="form3Example1c">Item Spesification</label>
                                                    <input type="text" id="spec" class="text-input" name="spec"
                                                        autocomplete="off" placeholder="Enter spesification" required />
                                                </div>
                                                <div class="col">
