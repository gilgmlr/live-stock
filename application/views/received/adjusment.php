    ...
    <div class="cards shadow p-1 mb-5 bg-white rounded">
        ...
        <div class=" card-body">
            <form action="<?= base_url() ?>received/add_Received" method="POST" autocomplete="off" style="font-weight:bold" ;>
                <div class="control-group after-add-more">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-sm-6">
                                <label for="" class="col-sm-6 col-form-label">Received Number*</label>
                                <input type="text" class="form-control" id="received_code" name="received_code"
                                    value="AD02-C02<?= substr(date('Y'),2,4) . date('m') ?>" required>
                ...
                <input type="text" class="form-control" id="desc" name="desc" value="Adjusment" hidden>
