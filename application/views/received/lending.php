                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="lending_no" name="lending_no" value="<?= $lending['lending_no'] ?>" readonly>
                                <label for="" class="col-sm-6 col-form-label">Lending Date</label>
                                <input type="text" class="form-control" id="lending_date" name="lending_date" value="<?= $lending['lending_date'] ?>" readonly>
                                <label for="" class="col-sm-6 col-form-label">Borrower Name</label>
                                <input type="text" class="form-control" id="borrower_name" name="borrower_name" value="<?= $lending['borrower_name'] ?>" readonly>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="item_code" name="item_code" value="<?= $lending['item_code'] ?>" readonly>
                                <label for="" class="col-sm-6 col-form-label">Lending Qty</label>
                                <input type="text" class="form-control" id="lending_qty" name="lending_qty" value="<?= $lending['lending_qty'] ?>" readonly>
                                <label for="" class="col-sm-6 col-form-label">UoM</label>
                                <input type="text" class="form-control" id="uom_code" name="uom_code" value="<?= $lending['uom_code'] ?>" readonly>
                                <label for="" class="col-sm-6 col-form-label">Department No</label>
                                <input type="text" class="form-control" id="dept_code" name="dept_code" value="<?= $lending['dept_code'] ?>" readonly>
